...
function price($fechaing, $cascos, $horaing, $preciohorabase, $stu)
{
    ...
    /************************************Parte de los Dias*************************************************/
      if ($Day == date("d", strtotime($fechaing)))
      {
        #echo "Los dias son iguales";
          ...
          if ($difhoras <= 4) {
            $Tpago= 1000 + ($cascos*100);
          }
          elseif ($difhoras > 4) {
              $Tpago = 1000 + (($difhoras-4)*$preciohorabase)+($cascos*100);
          }
      }
      else {
        ...
        $res = ($Thoras % 24)-4; /*Resto de horas, menos 4 que valdran mil pesos no mas*/
        if ($res <= 0) {
           $res = 0; /* si res es 0 o menos, es porque era menor a 4 entonces se tomara como 0 para que no afecte la ecuacion abajo*/
          }
        $Tpago = ($h24*3000)+($difdias*3000)+($res*$preciohorabase)+($cascos*100)+1000; /*Si difdias=0 no afectara, y si res=0 no afectara, si h24=0 no afectara*/
        }
    /*******************************************************************************/
      return $Tpago;
    }
  ...
  #_______________________________________________________________________________________________________
  #_________________________________________________ESTUDIANTE ARRIBA_____________________________________
  #_______________________________________________________________________________________________________
